...
#### XxxState.msg
\`\`\`
# 文件路径：codex_{module}_msgs/msg/XxxState.msg
# 枚举常量
uint8 STATE_A = 0
...
#### DoXxx.srv
\`\`\`
# 文件路径：codex_{module}_msgs/srv/DoXxx.srv
string requester
uint8 target
---
bool accepted
...
| 模块 | 交互方向 | 接口 | 说明 |
|------|----------|------|------|
| SM | {模块} → SM | /sm/request_transition | 说明 |
...
\`\`\`
# 文件路径：codex_{module}_msgs/msg/ErrorCode.msg
uint32 OK                    = 0
